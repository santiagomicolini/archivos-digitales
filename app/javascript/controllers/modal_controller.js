...
export default class extends Controller {
  ...
  openPdf(event) {
		...
		this.modalImgShellTarget.innerHTML = `<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="height: 100%; width: 580px;">
			<div class="carousel-inner" style="padding: 0 60px;">
