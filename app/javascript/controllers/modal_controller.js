...
export default class extends Controller {
  ...
  openPdf(event) {
		...
		this.modalImgShellTarget.innerHTML = `<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="height: 100%; width: 570px; padding: 0 70px;">
